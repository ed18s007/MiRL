...
def ce_loss_channel0(y_true, y_pred):
	return (categorical_crossentropy(y_true[..., 0],y_pred[..., 0]) )

def ce_loss_channel1(y_true, y_pred):
	return (categorical_crossentropy(y_true[..., 1],y_pred[..., 2]) )

def ce_loss_channel2(y_true, y_pred):
	return (categorical_crossentropy(y_true[..., 1],y_pred[..., 2]) )

def ce_loss_tot(y_true, y_pred):
    return (  ce_loss_channel0(y_true, y_pred)
         + (10*ce_loss_channel1(y_true, y_pred))
         + (10*ce_loss_channel2(y_true, y_pred)) )	

def total_loss(y_true, y_pred):
	return (ce_loss_tot(y_true, y_pred) +
