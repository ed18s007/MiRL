...
csvwriter("train_3d_X.csv", train_data_folder_path)
csvwriter("train_3d_y.csv", train_labels_folder_path)
csvwriter("test_3d_X.csv", test_data_folder_path)
csvwriter("test_3d_y.csv", test_labels_folder_path)
