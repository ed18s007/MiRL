...
with open(valid_hi,'r') as file_handle:
	...
	for line in file_handle:
		...
		ln = line.strip()       #.split(' ')
		valid_hi.append(ln)
# en_lines = ["And what is their Sigil?","I do not want to die.","It's the same country I think."
# "Then they'll be crying like babies.","And what is their Sigil?","I do not want to die.","It's the same country I think."
# "Then they'll be crying like babies.","And what is their Sigil?","I do not want to die.","It's the same country I think."
# "Then they'll be crying like babies.","And what is their Sigil?","I do not want to die.","It's the same country I think."
# "Then they'll be crying like babies."]
# hi_lines = ["और उनके Sigil क्या है?","मैं मरना नहीं चाहता.","यह मुझे लगता है कि एक ही देश है.","और उनके Sigil क्या है?","मैं मरना नहीं चाहता.","यह मुझे लगता है कि एक ही देश है.",
# "फिर ये नन्हें बच्चों की तरह रोएँगे।","और उनके Sigil क्या है?","मैं मरना नहीं चाहता.","यह मुझे लगता है कि एक ही देश है.",
# "फिर ये नन्हें बच्चों की तरह रोएँगे।","और उनके Sigil क्या है?","मैं मरना नहीं चाहता.","यह मुझे लगता है कि एक ही देश है.",
# "फिर ये नन्हें बच्चों की तरह रोएँगे।","फिर ये नन्हें बच्चों की तरह रोएँगे।"]
...
weights_matrix = np.zeros((matrix_len, glove_sz))
words_found = 0
...
#         words_found += 1
#     except KeyError:
#         weights_matrix[i] = np.random.normal(scale=0.6, size=(glove_sz, ))

class EncoderRNN(nn.Module):
	def __init__(self, num_embeddings, hid_size):
		super(EncoderRNN, self).__init__()
		self.hid_size = hid_size 
		self.embedding = nn.Embedding(num_embeddings, hid_size)
...
def evaluate(encoder, decoder, sentence, max_length=MAX_LENGTH):
    with torch.no_grad():
        ...
        for di in range(max_length):
            ...
            print("..........................")
            print("output_lang.",topi.item(),output_lang.index2word[topi.item()])
            print("...................xxxx")
...
trainIters(encoder_, attn_decoder1, iterations, print_every=50)
# trainIters(encoder_, decoder_, 7000, print_every=1000)

torch.save(encoder_.state_dict(), f'encoder.pt')
torch.save(attn_decoder1.state_dict(), f'encoder.pt')

evaluateRandomly(encoder_, attn_decoder1)
